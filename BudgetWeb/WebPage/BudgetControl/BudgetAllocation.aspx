                            ...
                            <Items>
                                ...
                                <ext:Panel ID="Panel1" runat="Server" Border="false" BaseCls="background:transeparent" ButtonAlign="Right">
                                    <Items>
                                        ...
                                        <ext:Label ID="Label3" runat="server" Text="年度预算下发金额"></ext:Label>
                               ...
                               <ext:Panel runat="Server" Border="false" BaseCls="background:transeparent" ButtonAlign="Right" MarginSpec="0 0 0 50"> 
                                    <Items>
