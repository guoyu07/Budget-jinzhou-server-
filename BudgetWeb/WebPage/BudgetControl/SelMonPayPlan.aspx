                ...
                <ext:GridPanel ColumnLines="true" ID="gridpanel1" runat="server" Layout="FitLayout" AutoScroll="true"
                    ...
                    <ColumnModel ID="cmAudit" runat="server" >
                        <Columns> 
                            ...
                            <ext:DateColumn  Sortable="true" ID="Monthcol" runat="server" Text="月份" Flex="1" DataIndex="MPTime" Format="MM"></ext:DateColumn>
                            ...
                            <Items>
                                <ext:Panel ID="Container1" Border="false" runat="server" Layout="ColumnLayout" MarginSpec="5 0 5 0">
                                    <Items>
                                        ...
                                        <ext:ComboBox MinWidth="60" ID="cmbdept" runat="server" ColumnWidth="0.2" DisplayField="DepName" ValueField="DepID">
                                            <Store>
                                                <ext:Store ID="cmbdeptstore" runat="server">
                                                    <Model>
                                                        <ext:Model ID="Model2" runat="server">
                                                            <Fields>
                                                                 <ext:ModelField Name="DepID" Type="string"></ext:ModelField>
