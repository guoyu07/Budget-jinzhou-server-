...
public partial class WebPage_BudgetControl_MonPayPlanNew : BudgetBasePage
{
    ...
    public void TextBind()
    {
        ...
        {
            lbtotal2.Text = ParToDecimal.ParToDel(Session["lbtotal2.Text"].ToString()).ToString("f8").TrimEnd('0').TrimEnd('.');
        }
        if (Session["lbtotal3.Text"] != null)
        {
            lbtotal3.Text = ParToDecimal.ParToDel(Session["lbtotal3.Text"].ToString()).ToString("f8").TrimEnd('0').TrimEnd('.');
        }
        if (Session["lbtotal4.Text"] != null)
        {
            lbtotal4.Text = ParToDecimal.ParToDel(Session["lbtotal4.Text"].ToString()).ToString("f8").TrimEnd('0').TrimEnd('.');
        }
        if (Session["lbtotal5.Text"] != null)
        {
            lbtotal5.Text = ParToDecimal.ParToDel(Session["lbtotal5.Text"].ToString()).ToString("f8").TrimEnd('0').TrimEnd('.');
        }
