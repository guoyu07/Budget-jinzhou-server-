...
public partial class verify_juzhangjijin : System.Web.UI.Page, IPostBackEventHandler
{
    ...
    {
        string sqlstr = "select BQJE,SQJE,ZJJE,Depname,LSJL from RM_keshiyewufei where Remark1='" + DateTime.Now.Year + "' and Remark=1";
