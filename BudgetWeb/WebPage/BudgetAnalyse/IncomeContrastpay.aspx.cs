...
public partial class WebPage_BudgetControl_IncomeContrastpay : BudgetBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        Getmonth();
        DepDataBind();
        cmbmon.SelectedItem.Text = DateTime.Now.Month.ToString().Length == 1 ? "0" + DateTime.Now.Month.ToString() : DateTime.Now.Month.ToString();
        ...
        cmbmon.Items.Insert(0, new Ext.Net.ListItem("全部", "0"));
    }

    void FloatUnit_Click(object sender, EventArgs e)
    {
        Response.Redirect("IncomeContrastpay.aspx");
    }
