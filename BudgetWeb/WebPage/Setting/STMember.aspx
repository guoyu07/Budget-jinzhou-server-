        ...
        <script type="text/javascript">
            var selectionChanged = function(selModel, selected) {
                if (selected.length > 0 && selected[0].childNodes.length == 0) {
                    ...
                    if (uid == undefined) { alert("请先添加部门"); }
                    else { App.direct.Memberselect(uid); }
                                ...
                                <Items>
                                    ...
                                    <ext:FieldSet ID="FieldSet1"
                                        ...
                                        <Items>
                                            ...
                                            <%--<ext:Radio ID="Radio19" runat="server" FieldLabel="局长基金" BaseCls="font-color:red;" Checked="False" OnDirectCheck="Radio2_DirectCheck"></ext:Radio>--%>
...
<%--                                    </Defaults>--%>
                                    ...
                                    <ext:CheckboxGroup Layout="AnchorLayout" ID="CheckboxGroup1"   runat="server"   >
<%--                                           <Defaults>--%>
<%--                                        <ext:Parameter Name="labelWidth" Value="20" Mode="Raw" />--%>
<%--                                                <ext:Parameter Name="Width" Value="20" Mode="Raw" />--%>
<%--                                    </Defaults>--%>
                                        <Items>
                                            <ext:Checkbox ID="Radio9" runat="server" FieldLabel="费用报销单" Checked="False"></ext:Checkbox>
                                            <ext:Checkbox ID="Radio10" runat="server" FieldLabel="科室业务费报销单" Checked="False" ></ext:Checkbox>
                                            <ext:Checkbox ID="Radio11" runat="server" FieldLabel="局长基金"  Checked="False"></ext:Checkbox>
                                        </Items>
                                    </ext:CheckboxGroup>
                                               </Items> </ext:FieldSet>
