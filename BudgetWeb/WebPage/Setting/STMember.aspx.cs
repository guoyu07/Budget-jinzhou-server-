...
public partial class WebPage_Setting_STMember : BudgetBasePage
{
 ...
 user.UserDescription="出纳员"; 
    ...
    //protected void Radio2_DirectCheck(object sender, DirectEventArgs e)
    //{
    //    if (Radio19.Checked)
    //    {
    //        Radio11.Enable(Radio19.Checked);
    //    }
    //    else { Radio11.Disable(Radio19.Checked); Radio11.Checked = false; } 
    //}
}